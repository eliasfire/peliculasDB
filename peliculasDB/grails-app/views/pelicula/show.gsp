...
<%@ page import="com.ar.ush.Pelicula" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-pelicula" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:peliculaInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${peliculaInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
